...
namespace SpriteAnimsTest {
    public class SpriteAnimsTestGame : Game {
        ...
        protected override void LoadContent() {
            ...
            // Carica la musica di sottofondo e di vittoria
            _backgroundMusic = Content.Load<Song>("groundtheme");
            _winMusic = Content.Load<Song>("levelcomplete");
            ...
            goombaTX = Content.Load<Texture2D>("enemies");
            ...
            // Istanzia il player e i goomba
            _player = new Player(marioTexture, new Vector2(50, 100), jumpSound, deathSound, _backgroundMusic);
            goomba = new Goomba(goombaTX, new Vector2(500, 180));
            goomba = new Goomba(goombaTX, new Vector2(800, 180));
            goomba = new Goomba(goombaTX, new Vector2(1800, 180));
            goomba = new Goomba(goombaTX, new Vector2(2400, 120));
            goomba = new Goomba(goombaTX, new Vector2(2500, 120), 1);
            goomba = new Goomba(goombaTX, new Vector2(2820, 120));
            ...
            goombas.Add(new Goomba(goombaTX, new Vector2(500, 180)));
            goombas.Add(new Goomba(goombaTX, new Vector2(500, 180)));
            goombas.Add(new Goomba(goombaTX, new Vector2(800, 180)));
            goombas.Add(new Goomba(goombaTX, new Vector2(1800, 180)));
            goombas.Add(new Goomba(goombaTX, new Vector2(2400, 120)));
            goombas.Add(new Goomba(goombaTX, new Vector2(2500, 120), 1));
            goombas.Add(new Goomba(goombaTX, new Vector2(2820, 120)));
        ...
        protected override void UnloadContent()
        {
            ...
            // Clear obstacles and enemies collections
            _obstacles.Clear();
            goombas.Clear();
        ...
        protected override void Update(GameTime gameTime) {
            ...
            if (!isPaused && !win) {
                ...
                foreach (Goomba goomba in goombas) {
                    goomba.Update(gameTime, cameraX, visibleWidthInTexture);
                }
        ...
        protected override void Draw(GameTime gameTime) {
            ...
            foreach (Goomba goomba in goombas)
            {
                goomba.Draw(_spriteBatch, cameraX, scale);
            }
            ...
            if (isPaused) {
                ...
                Vector2 textPos = new((screenWidth - textSize.X) / 2, (screenHeight - textSize.Y) / 2);
                _spriteBatch.DrawString(pauseFont, pauseText, textPos, Color.White);
                _spriteBatch.End();
            }

            if (win) {
                if (MediaPlayer.Queue.ActiveSong != _winMusic) {
                    MediaPlayer.Stop();
                ...
                _spriteBatch.Begin();
                string winText1 = "YOU WON";
                string winText2 = "PRESS ENTER TO RESTART";
                Vector2 textSize = pauseFont.MeasureString(winText1);
                Vector2 textSize1 = pauseFont.MeasureString(winText2);
                Vector2 textPos = new((screenWidth - textSize.X) / 2, (screenHeight - textSize.Y) / 2);
                Vector2 textPos1 = new((screenWidth - textSize1.X) / 2, (screenHeight+50) / 2);
                _spriteBatch.DrawString(pauseFont, winText1, textPos, Color.White);
                _spriteBatch.DrawString(pauseFont, winText2, textPos1, Color.White);
                _spriteBatch.End(); 
